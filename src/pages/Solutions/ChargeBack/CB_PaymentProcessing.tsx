...
import { CBPaymentSol } from "../../../data/chargebackpaymentSol";
import { ShieldCheck    } from "lucide-react";


export default function CB_PaymentProcessing() {
    ...
    return (
        <section id="pricing" className="border-b border-gray-200 px-4 md:px-16 lg:px-24 xl:px-32 border-t divide-gray-200">
            <div className="p-4 pt-20 flex flex-col items-center max-w-7xl mx-auto justify-center border-x border-gray-200">
                <SectionTitle
                    icon={ShieldCheck   }
                    title="Start Chargeback-Safe Processing"
                    subtitle="Follow these simple steps to set up your online merchant account.Simple process to set up your merchant account"
                />
                <div className="flex flex-wrap items-start justify-center gap-10 md:gap-4 px-4 mt-12">
                    {CBPaymentSol.map((plan, index) => (
