...
export default function MS_HeroSection() {
    return (
            ...
            <div className="w-full max-w-2xl mt-35 lg:mt-0 flex flex-col items-center justify-center ">
                <AnimatedContent distance={30} delay={0.1} className="relative">
                    <h1 className="text-center font-urbanist text-5xl/15 md:text-6xl/18 mt-4 font-bold max-w-2xl">
                        Transform Your Business with Our Merchant Services
                    </h1>
                ...
                <AnimatedContent distance={30} delay={0.2}>
                    <p className="text-center text-base/7 text-zinc-500 max-w-lg mt-4">
                        Our merchant services provide everything you need to process payments and grow your business. Here’s what you get:
                    </p>
                </AnimatedContent>
                <AnimatedContent className="flex flex-col md:grid grid-cols-2 items-center gap-3 mt-6 w-full md:w-auto">
                    <div className="flex flex-col gap-1 relative py-3 md:py-2.5 w-full md:w-auto px-8 bg-white/50 text-gray-600 font-medium border border-white rounded-2xl">
                        <span className="text-md font-bold flex gap-1 items-center"><Sparkles  className="text-orange-500 size-5"/>Dedicated merchant account</span>
                    </div>
                    <div className="flex flex-col gap-1 relative py-3 md:py-2.5 w-full md:w-auto px-8 bg-white/50 text-gray-600 font-medium border border-white rounded-2xl">
                        <span className="text-md font-bold flex gap-1 items-center"><Sparkles  className="text-orange-500 size-5"/>Next-day merchant funding</span>
                    </div>
                    <div className="flex flex-col gap-1 relative py-3 md:py-2.5 w-full md:w-auto px-8 bg-white/50 text-gray-600 font-medium border border-white rounded-2xl">
                        <span className="text-md font-bold flex gap-1 items-center"><Sparkles  className="text-orange-500 size-5"/>Complete merchant toolkit</span>
                    </div>
                    <div className="flex flex-col gap-1 relative py-3 md:py-2.5 w-full md:w-auto px-8 bg-white/50 text-gray-600 font-medium border border-white rounded-2xl">
                        <span className="text-md font-bold flex gap-1 items-center"><Sparkles  className="text-orange-500 size-5"/>24/7 merchant support</span>
                    </div>
                </AnimatedContent>
            </div>
